...
function win_upload() {
	...
	open("${pageContext.request.contextPath}/myMember/pictureimgForm", "", op);
}
</script>
</head>
	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" novalidate action="myMemberUpdatePro"
					method="post">
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									<label for="id">아이디</label> <input type="text"
										class="form-control" id="id" name="id" value="${mem.id}"
										readonly>
									<div class="invalid-feedback">아이디을 입력해주세요.</div>
								</div>
								<div class="col-md-6 mb-3">
									<label for="name">이름</label> <input type="text"
										class="form-control" id="name" name="name" value="${mem.name}"
										required>
					...
					<div class="col-md-9 mb-3">
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="id">주소</label> <input type="text"
									class="form-control" id="address" name="address" value="${mem.address}">
								<div class="invalid-feedback">아이디을 입력해주세요.</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-9 mb-3">
						<div class="row">
							<div class="col-md-6 mb-3">
								<label for="id">생일</label> <input type="text"
									class="form-control" id="birth" name="birth" value="${mem.birth}">
								<div class="invalid-feedback">아이디을 입력해주세요.</div>
							</div>
						</div>
					</div>
					...
					<div class="mb-3">
						<label for="tel">전화번호</label> <input type="text"
							class="form-control" id="tel" name="tel" value="${mem.tel}"
							required>
					...
					<div class="mb-3">
						<label for="email">이메일</label> <input type="email"
							class="form-control" id="email" name="email" value="${mem.email}"
							required>
